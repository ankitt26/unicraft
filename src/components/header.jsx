...
export default function Header() {
  return (
    <header className=" mt-5 w-full font-Satoshi text-gray-700 sm:mt-1">
      <nav className="mx-auto flex h-20 w-[90%] flex-row items-center justify-between">
        ...
        <ul className=" flex h-6 flex-row flex-wrap justify-center gap-12 text-lg font-medium tracking-[-0.48px] text-gray-700 sm:hidden">
